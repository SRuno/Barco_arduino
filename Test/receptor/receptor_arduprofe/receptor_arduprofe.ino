...
const uint64_t pipeIn = 0xE8E7F0F0E1LL;     //Mismo codigo en el RX y TX
...
void setup()
{
  pinMode(7, OUTPUT);        // salida digital 7 para el buzzer
  Serial.begin(9600);
...
void loop()
{
  ...
  if (ch1_value <=1100){          // si el valor es alto o bajo 
    digitalWrite(7,1);       // activa buzzer
  }
  else{
    digitalWrite(7,0);       // apaga el buzzer
  }
